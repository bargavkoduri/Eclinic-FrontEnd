            ...
            <form onSubmit = {handleSubmit} >
                <div style={{textAlign: "center" ,padding: "4%"}}>
                    ...
                    <div style={{textAlign:"right"}}>
                        <footer className="blockquote-footer">Are you a doctor? <cite
                            title="Source Title"><a href="/signup/doctor">Register here</a></cite></footer>
                ...
                <div className="row mb-4">
                    ...
                    <div className="col-10">
                        <input name="passwordr" type="password" id="form3Example4cd"
                               ...
                               onChange={handleInputChange}  placeholder="Repeat your password"/>
                ...
                <div className="d-flex justify-content-center mx-4 mb-3 mb-lg-4" style={{paddingTop:"9%"}}>
                    <button type="submit" id="but" className="btn btn-dark btn-lg">Get OTP
                    </button>
                </div>
