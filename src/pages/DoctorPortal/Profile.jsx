...
export default function Profile() {
  ...
  useEffect(()=>{
    ...
    axios.get(`${SERVER_URL}/doctor/${id}/getinfo`, {
      headers: {
  ...
  const uploadPhoto = () => {
    const { id, jwtToken } = JSON.parse(localStorage.getItem("items"));
    axios
        .post(`${SERVER_URL}/doctor/${id}/updatedp`, ProfiePic, {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
          },
        })
  ...
  const Submithandler = () => {
    const { id, jwtToken } = JSON.parse(localStorage.getItem("items"));
    axios
        .post(`${SERVER_URL}/doctor/${id}/update`,state, {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
          },
        })
  ...
  const PassSubmithandler = () => {
    const { id, jwtToken } = JSON.parse(localStorage.getItem("items"));
    axios
        .post(`${SERVER_URL}/doctor/${id}/update`,{password: passState.password}, {
          headers: {
            Authorization: `Bearer ${jwtToken}`,
          },
        })
